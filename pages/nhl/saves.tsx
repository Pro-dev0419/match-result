...
const TABLE_COLUMNS: GridColDef[] = [
  ...
  { field: "PROJECTED SAVES", headerName: "Saves" },
  { field: "LINE_DK", headerName: "LINE_DK" },
  { field: "AMERICAN_DK", headerName: "DK" },
  { field: "ROI_DK", headerName: "ROI_DK", type: 'number',
    renderCell: (params) =>
    <p>
      <a href="https://sportsbook.draftkings.com/leagues/hockey/nhl?category=goalie-props">{params.row.ROI_DK}%</a>
      <IconButton href="https://sportsbook.draftkings.com/leagues/hockey/nhl?category=goalie-props"> <LaunchIcon />
      </IconButton>
    </p>,
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await fetch("/api/nhl/saves").then((o) => o.json());
        setData(res.data);
      } catch (e) {
      } finally {
        setLoading(false);
