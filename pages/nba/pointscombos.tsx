...
const TABLE_COLUMNS: GridColDef[] = [
  ...
  { field: "PA", headerName: "Proj", width: 75 },
  ...
  { field: "DIFF_DK", headerName: "DIFF_DK", width: 75 },
  { field: "ROI_DK", headerName: "ROI_DK", type: 'number', width: 100,
    renderCell: (params) =>
    <p>
      <a href="https://sportsbook.draftkings.com/leagues/basketball/nba?category=player-combos">{params.row.ROI_DK}%</a>
      <IconButton href="https://sportsbook.draftkings.com/leagues/basketball/nba?category=player-combos"> <LaunchIcon />
      </IconButton>
    </p>,
  ...
  { field: "DIFF_FD", headerName: "DIFF_FD", width: 75 },
  ...
  { field: "DIFF_MGM", headerName: "DIFF_MGM", width: 75 },
  ...
  { field: "DIFF_CZR", headerName: "DIFF_CZR", width: 75 },
...
{ field: "DIFF_RIV", headerName: "DIFF_RIV", width: 75 },
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await fetch("/api/nba/pointscombos").then((o) => o.json());
