...
const TABLE_COLUMNS: GridColDef[] = [
  ...
  { field: "REBOUNDS", headerName: "Proj", width: 75 },
  ...
  { field: "ROI_DK", headerName: "ROI_DK", type: 'number', width: 100,
    renderCell: (params) =>
    <p>
      <a href="https://sportsbook.draftkings.com/leagues/basketball/nba?category=player-props&subcategory=rebounds">{params.row.ROI_DK}%</a>
      <IconButton href="https://sportsbook.draftkings.com/leagues/basketball/nba?category=player-props&subcategory=rebounds"> <LaunchIcon />
      </IconButton>
    </p>,
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await fetch("/api/nba/rebounds").then((o) => o.json());
  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        <h1 className={styles.title}>Rebounds</h1>
